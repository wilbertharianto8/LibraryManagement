            ...
            <div class="d-table w-100 content mt-5">
                <div class="d-table-cell align-middle">
                    <div class="d-flex flex-column">
                        ...
                        <a href="index.html" class="forgot align-self-center font-italic mt-5 text-dark">Not a Customer?</a>
                        
                        <a href="registration.jsp" class="forgot align-self-center font-italic mt-5 text-dark">Don't have account?</a>
