...
<html>
    ...
    <body>
        <div class="w-100 mb-5">
            <div class="header p-3 m-2 text-center h5 font-weight-bold">e-Book<a href="staffHomepage.jsp"><p style="text-align:right;">Homepage</p></a></div>           
        </div>
