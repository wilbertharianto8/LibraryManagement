        ...
        <form method="post" action="registrationController.jsp">
            <div class="container mt-2 w-25">
                <div class="d-flex flex-column">
                    ...
                    <input type="text" name="custUsername" value="" required />
                    <div class="py-3">Full Name</div>
                    <input type="text" name="custFullname" value="" required/>
                    <div class="py-3">Email</div>
                    <input type="email" name="custEmail" value="" required/>
                    <div class="py-3">Address</div>
                    <input type="text" name="custAddress" value="" required/>
                    <div class="py-3">Password</div>
                    <input type="password" minlength="9" maxlength="100" name="custPassword" value="" title="need to be more than 8 characters" required/>
                    <div class="py-3">Phone Number</div>
                    <input type="tel" name="custPhone" pattern="01[0-9]{9}" title="must start with 01 followed by another 9 digits of number" required />
